...
class Detail extends Component {
    ...
    buynow = ({ iname, goodsnum }) => {
        ...
        let sumgoods = JSON.parse(localStorage.getItem('sumgoods'));
        ...
        if (!phone) {
            ...
            if (loaclcart) {
                ...
                if (!isok2) { loaclcart.push({ title: iname, qty: goodsnum }) }
                localStorage.setItem('sumgoods', JSON.stringify(loaclcart))
            } else {
                localStorage.setItem('usergoods', JSON.stringify([{ title: iname, qty: goodsnum }]))
            }
        }
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <div onClick={this.showit}
                                        style={{
                                            color: '#000', fontSize: '4vw', float: 'left', width: '38.265vw', fontWeight: "bold",
                                            marginBottom: '4vw'
                                        }}>
                                        再看看
                                </div>
                                    <div style={{
                                        width: '0.266vw', height: '5.33vw', float: 'left', background: '#999', ontWeight: "bold",
                                        marginTop: '1vw'
                                    }}>
                                        &nbsp;
                                </div>
